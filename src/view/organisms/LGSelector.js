...
import { Select, MenuItem, CircularProgress, Box, Typography, FormControl, InputLabel, Menu } from "@mui/material";
...
export default class LGSelector extends Component {
  ...
  async componentDidMount() {
    ...
    const lgList = lgListUnsorted.filter(
        function(lg) {
  ...
  render() {
    ...
    return (
      <Box>
        <Select label="Local Authority" value={selectedLGID} onChange={onChange}>
            {lgList.map(
                function(lg) {
