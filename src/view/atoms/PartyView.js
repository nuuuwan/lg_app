...
export default function PartyView({ partyName }) {
  ...
  if (symbol_src) {
    ...
    inner= <img src={party.symbol_src} alt={partyName} style={{...STYLE_IMG_SYMBOL,...styleImgSymbolCustom}} />;
  }  else {
    inner= partyName;
  }
  ...
  return <div style={STYLE} onClick={onClick} className="clickable">{inner}</div>;
